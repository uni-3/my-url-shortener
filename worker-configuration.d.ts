/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8273a552b144a5ade154e82e25f55a79)
// Runtime types generated with workerd@1.20260131.0 2026-02-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "UrlChatAgent";
	}
	interface DevelopmentEnv {
		IMAGES: ImagesBinding;
		ENVIRONMENT: "development";
		LOG_LEVEL: "debug";
		SHORTENER_BASE_URL: "https://dev-s.uni-3.app";
		WORKER_SELF_REFERENCE: Fetcher /* my-url-shortener-dev */;
	}
	interface ProductionEnv {
		...
		SHORTENER_BASE_URL: "https://s.uni-3.app";
	...
	interface Env {
		...
		SHORTENER_BASE_URL: "https://dev-s.uni-3.app" | "https://s.uni-3.app" | "http://localhost:8788";
		WORKER_SELF_REFERENCE?: Fetcher /* my-url-shortener-dev */ | Service<typeof import("./worker").default>;
		URL_CACHE?: KVNamespace;
		DB?: D1Database;
		GRAFANA_OTLP_ENDPOINT?: "https://otlp-gateway-prod-ap-northeast-0.grafana.net/otlp/v1/traces";
		ASSETS?: Fetcher;
		UrlChatAgent?: DurableObjectNamespace<import("./worker").UrlChatAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "LOG_LEVEL" | "SHORTENER_BASE_URL" | "GRAFANA_OTLP_ENDPOINT">> {}
}
